...
const STUDENT_A = "00000000-0000-4000-8000-000000000301";
const STUDENT_D = "00000000-0000-4000-8000-000000000304";
const NOVA = "00000000-0000-4000-8000-000000000399";

const base = (seq: number, text: string, actorId = STUDENT_A): RoomEventEnvelope => {
  const common = {
    ...
    payload: { messageId: `00000000-0000-4000-8003-${String(seq).padStart(12, "0")}`, text, replyTo: null, mentions: [], mediaIds: [] },
  };
...
describe("session projections", () => {
  it("is idempotent and produces evidence-backed concept/social projections", () => {
    ...
    const two = base(2, "我不確定能量會不會循環", STUDENT_D);
