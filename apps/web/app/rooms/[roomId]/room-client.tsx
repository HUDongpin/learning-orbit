...
const initialMessages: Message[] = [
  ...
  seed("m2", "evt-2", "student-b", "生產者把光能儲存在有機物裡，再傳給消費者。", "09:06", { replyTo: "m1" }),
...
export default function RoomClient({ roomId }: { roomId: string }) {
  ...
  // Kept as a compatibility alias for the compact JSX toolbar below; the
  // standalone HTML demo exposes separate pause controls.  Chat submission
  // itself no longer depends on this flag.
